\chapter{OOP 2: Datenkapselung}
\renewcommand{\chaptertitle}{OOP 2: Datenkapselung}
...
\begin{center}
\includegraphics[width=0.6\textwidth]{./inf/SEKII/11_Java_Datenkapselung/tisch-konfigurator.png}
\end{center}
