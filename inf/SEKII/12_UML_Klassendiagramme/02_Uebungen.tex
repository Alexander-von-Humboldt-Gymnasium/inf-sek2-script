...
%\begin{center}
\includegraphics[width=0.8\textwidth]{./inf/SEKII/12_UML_Klassendiagramme/Aufgabe1.png}
%\end{center}
...
\begin{center}
\includegraphics[width=0.7\textwidth]{./inf/SEKII/12_UML_Klassendiagramme/Computer-Komponenten.png}
\end{center}
