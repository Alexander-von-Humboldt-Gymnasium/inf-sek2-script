...
\url{https://www.dropbox.com/s/tasduzleda46k5q/mysql-connector-java-5.1.45-bin.jar?dl=0}
...
\ldots} $\rightarrow$ wähle \myFile{mysql-connector-java-5.1.45-bin.jar} in
...
Den Pfad zu \myFile{mysql-connector-java-5.1.45-bin.jar} (oder neuere Version)
