...
\url{https://www.dropbox.com/s/kjolp95yfpu6fyu/mysql-connector-java-8.0.11.jar?dl=0}
...
\ldots} $\rightarrow$ wähle \myFile{mysql-connector-java-8.0.11.jar} in
...
Den Pfad zu \myFile{mysql-connector-java-8.0.11.jar} (oder neuere Version)
