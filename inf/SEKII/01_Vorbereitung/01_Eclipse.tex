...
\url{http://dl.dropbox.com/u/31241540/mysql-connector-java-5.1.39-bin.jar}
...
\ldots} $\rightarrow$ wähle \myFile{mysql-connector-java-5.1.39-bin.jar} in
...
Den Pfad zu \myFile{mysql-connector-java-5.1.39-bin.jar} (oder neuere Version)
