...
\section{OOP 3: Vererbung -- Übungen}
...
\includegraphics[width=1.0\textwidth]{./inf/SEKII/13_Java_Vererbung/Aufgabe1.png}
...
\includegraphics[width=0.3\textwidth]{./inf/SEKII/13_Java_Vererbung/Aufgabe2.png}
...
\myFile{13\_Java\_Vererbung}) von \verb|private| nach \verb|protected|.
...
\includegraphics[width=0.8\textwidth]{./inf/SEKII/13_Java_Vererbung/Aufgabe3.png}
...
\includegraphics[width=0.8\textwidth]{./inf/SEKII/13_Java_Vererbung/Aufgabe4a.png}
\end{minipage}
...
\hfill
\begin{minipage}{0.3\textwidth}
\includegraphics[width=0.8\textwidth]{./inf/SEKII/13_Java_Vererbung/Aufgabe4b.png}
\end{minipage}

\begin{minipage}{0.6\textwidth}
\item Im selben Package sollst du nun auch noch eine Klasse
\myClass{SchweifDrachen} programmieren , die sich von der Klasse
\myClass{GesichtDrachen} ableitet (siehe Abbildung). Der Konstruktor dieser
Klasse soll einen zusätzlichen Parameter haben, der die Farbe für den
Schweif des Drachen angibt. Überschreibe die Methode \verb|zeichnen()| und
...
\myClass{SchweifDrachen}.
\end{minipage}
\hfill
\begin{minipage}{0.3\textwidth}
\includegraphics[width=0.8\textwidth]{./inf/SEKII/13_Java_Vererbung/Aufgabe4c.png}
\end{minipage}
\end{compactenum}
...
\hfill
\begin{minipage}{0.3\textwidth}
\includegraphics[width=0.8\textwidth]{./inf/SEKII/13_Java_Vererbung/Aufgabe5b1.png}
\end{minipage}
...
\hfill
\begin{minipage}{0.4\textwidth}
\includegraphics[width=1.0\textwidth]{./inf/SEKII/13_Java_Vererbung/Aufgabe5b2.png}
\end{minipage}
...
\begin{center}
\includegraphics[width=0.4\textwidth]{./inf/SEKII/13_Java_Vererbung/Aufgabe5d.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.4\textwidth]{./inf/SEKII/13_Java_Vererbung/Billiards_balls.jpg}
...
\begin{center}
\includegraphics[width=1.0\textwidth]{./inf/SEKII/13_Java_Vererbung/Aufgabe6.png}
\end{center}
...
\includegraphics[width=1.0\textwidth]{./inf/SEKII/13_Java_Vererbung/abprallen_oben.png}
\end{minipage}
\hfill
...
\hfill
\begin{minipage}{0.2\textwidth}
\includegraphics[width=0.4\textwidth]{./inf/SEKII/13_Java_Vererbung/abprallen_seite.png}
\end{minipage}
\begin{minipage}{0.2\textwidth}
\begin{tabular}{ll}
\textbf{vorher:}  & vX = \\
