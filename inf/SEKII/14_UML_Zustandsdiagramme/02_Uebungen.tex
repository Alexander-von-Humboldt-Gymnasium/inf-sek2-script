...
\begin{center}
\includegraphics[width=1.0\textwidth]{./inf/SEKII/14_UML_Zustandsdiagramme/windows.png}
\end{center}
\end{minipage}
...
\begin{center}
\includegraphics[width=0.4\textwidth]{./inf/SEKII/14_UML_Zustandsdiagramme/faehre.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.5\textwidth]{./inf/SEKII/14_UML_Zustandsdiagramme/phone_alarm.png}
\end{center}
