...
\section{OOP 2: Datenkapselung -- Übungen}
...
\begin{center}
\includegraphics[width=0.5\textwidth]{./inf/SEKII/11_Java_Datenkapselung/haus.png}
\end{center}
\end{minipage}
...
\begin{center}
\includegraphics[width=0.9\textwidth]{./inf/SEKII/11_Java_Datenkapselung/lampeUML.png}
\end{center}
\end{minipage}
...
\begin{center}
\includegraphics[width=0.5\textwidth]{./inf/SEKII/11_Java_Datenkapselung/ampel.png}
\end{center}
\end{minipage}
...
\begin{minipage}{0.1\textwidth}
\begin{center}
\includegraphics[width=1.\textwidth]{./inf/SEKII/11_Java_Datenkapselung/digitaluhr.png}
\end{center}
\end{minipage}
...
\begin{center}
\includegraphics[width=0.7\textwidth]{./inf/SEKII/11_Java_Datenkapselung/digitaluhrUML.png}
\end{center}
\end{minipage}
