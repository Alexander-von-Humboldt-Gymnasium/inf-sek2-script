...
Mit Hilfe der Klasse \myClass{ProcessBuilder} können von einem Java-Programm aus andere
Programme gestartet werden. 

\begin{lstlisting}
Process process = new ProcessBuilder("auszuführendesProgramm").start();
\end{lstlisting}

Die Methode \lstinline|start()| erzeugt eine \myClass{IOException}, wenn das 
angegebene Programm nicht gefunden werden konnte.
