...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.84\textwidth]{./inf/SEKII/01_Vorbereitung/Eclipse-Workspace-Preferences.png}
...
\myPMI{Next} $\rightarrow$ \myPMI{Next} $\rightarrow$ \myPMI{Next} $\rightarrow$
\myPMI{Finish} $\rightarrow$ \myPMI{Java} $\rightarrow$ \myPMI{Java Project}
...
\ldots} $\rightarrow$ wähle \myFile{mysql-connector-java-5.1.36-bin.jar} in
...
Den Pfad zu \myFile{mysql-connector-java-5.1.36-bin.jar} (oder neuere Version)
