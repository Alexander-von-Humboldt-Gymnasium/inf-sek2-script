...
\myFile{mysql-installer-web-community-8.0.12.0.msi}. Dabei handelt es sich um
...
\myFile{mysql-connector-java-8.0.12.jar}
...
\subsubsection{Konfiguration in Eclipse}

Die Konfiguration des DBeaver Plugins für Eclipse wird im Kapitel 1
