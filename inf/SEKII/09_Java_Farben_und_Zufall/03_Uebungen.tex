...
Breite.
\begin{center}
\includegraphics[width=0.15\textwidth]{./inf/SEKII/09_Java_Farben_und_Zufall/baum.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.5\textwidth]{./inf/SEKII/09_Java_Farben_und_Zufall/Aufgabe1.png}
\end{center}
...
\begin{minipage}{0.45\textwidth}
\centering
\includegraphics[width=1.0\textwidth]{./inf/SEKII/09_Java_Farben_und_Zufall/Aufgabe4.png}
\end{minipage}
